...
const TempDetails = ({
  ...
  return (
    <div>
      ...
      <div className="flex flex-row items-center justify-between text-white py-3 w-5/6 mx-auto">
      ...
      <div className="flex flex-row items-center justify-center m-10 space-x-2 text-white text-sm py-3">
        <UilSun />
